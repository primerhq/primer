...
def test_u0047_provider_list_reflects_new_row_after_modal_create(
    ...
    try:
        # The catalog creates through an inline form: the per-class New
        # provider modals it replaced are gone, and with them the round
        # trip out to a detail page and back. The list and the form sit
        # side by side, so a new row has to appear in place.
