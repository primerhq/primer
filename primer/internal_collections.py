...
class InternalCollectionsSubsystem:
    ...
    async def _ingest_ai_docs(self, emit, counts) -> int:
        """Removed in v2.

        The shipped agent docs are written into the system collection as
        tree documents by primer.knowledge.system_collection, which needs
        no loader and no embedder.
        """
        return 0
