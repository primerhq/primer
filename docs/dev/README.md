...
- [deferred-from-specs.md](deferred-from-specs.md) - the catalogue of spec-proposed
  work that the current code has not yet implemented (generated by the verifier).
