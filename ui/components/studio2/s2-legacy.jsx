...
window.S2_LEGACY_ROUTES = [
  ...
  { ref: "/providers/llm",                   title: "LLM Providers",        group: "compute" },
  { ref: "/model-profiles",                  title: "Model Profiles",       group: "compute" },
  { ref: "/providers/embedding",             title: "Embedding",            group: "compute" },
  { ref: "/providers/cross_encoder",         title: "Cross-Encoder",        group: "compute" },
  { ref: "/web-search",                      title: "Web Search",           group: "compute" },
