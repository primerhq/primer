...
(function () {
  ...
  const routes = [
    ...
    { pattern: "/workspaces/providers",            page: "WorkspaceProvidersListPage" },
    { pattern: "/workspaces/providers/:id",        page: "WorkspaceProviderDetailPage" },
    { pattern: "/workspaces/templates",            page: "WorkspaceTemplatesListPage" },
    { pattern: "/workspaces/templates/:id",        page: "WorkspaceTemplateDetailPage" },
...
{ pattern: "/toolsets",                        page: "ToolsetsListPage" },
    ...
    { pattern: "/services/:id",                    page: "ServicesPage" },
