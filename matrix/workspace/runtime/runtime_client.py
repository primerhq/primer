...
from matrix.int.sandbox import ExecResult, FileStat
from matrix.workspace.runtime.protocol import ErrorCode, OpName, Request
...
class RuntimeClient:
    ...
    async def _send_raw(self, msg: Request) -> None:
        ...
        from matrix.workspace.runtime.protocol import serialize
    ...
    def _dispatch_text(self, text: str) -> None:
        ...
        from matrix.workspace.runtime.protocol import deserialize
